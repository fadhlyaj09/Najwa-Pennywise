    ...
    <div className="grid grid-cols-2 gap-4">
      <Card>
        ...
        <CardContent className="p-4 pt-0">
          <div className="text-base font-bold break-all">{formatRupiah(income)}</div>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 p-4">
        ...
        <CardContent className="p-4 pt-0">
          <div className="text-base font-bold break-all">{formatRupiah(expenses)}</div>
        </CardContent>
      </Card>
      <Card className="col-span-2">
        ...
        <CardContent className="p-4 pt-0">
          <div className={`text-base font-bold break-all ${balance >= 0 ? 'text-foreground' : 'text-destructive'}`}>
